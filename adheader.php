...
<head>
    ...
    <title>Larut Matang E-Clinic Management System - Admin</title>
    ...
    <nav class="navbar clearHeader">
        <div class="col-12">
            <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand"
                href="#">Larut Matang E-Clinic Management System</a> </div>
                    ...
                    <!-- <li> <a href="javascript:void(0);" class="menu-toggle toggled waves-effect waves-block"><i
                        ...
                        <li><a href="javascript:void(0);" class="menu-toggle"><i
                            ...
                            <ul class="ml-menu">
                                ...
                                <li><a href="viewtreatment.php" class=" waves-effect waves-block">View Treatment Type</a></li>
                    ...
                    <ul class="list">
                        ...
                        <li class="active open"><a href="patientaccount.php"><i
                            ...
                            <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>Appointment</span> </a>
                                <ul class="ml-menu">
                                    <li><a href="patientaddappointment.php" >Add Appointment</a></li>

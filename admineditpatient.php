...
<div class="container-fluid">
    <div class="block-header">
        <h2 class="text-center">Patient's Profile</h2>
    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <div class="form-line">
                                            <input class="form-control" type="text" name="loginid" id="loginid"  readonly value="<?php echo $rsedit['loginid']; ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        if(isset($_GET['editid']))
        {
            $sql ="UPDATE patient SET patientname='$_POST[patientname]',admissiondate='$_POST[admissiondate]',admissiontime='$_POST[admissiontme]',address='$_POST[address]',mobileno='$_POST[mobilenumber]',city='$_POST[city]',pincode='$_POST[pincode]',loginid='$_POST[loginid]',bloodgroup='$_POST[select2]',gender='$_POST[select3]',dob='$_POST[dateofbirth]' WHERE patientid='$_GET[editid]'";

            if($qsql = mysqli_query($con,$sql))
            {
                echo "<script>alert('Patient record updated successfully');";
                echo "window.location.href='viewpatient.php';</script>";
            }
            else
            {

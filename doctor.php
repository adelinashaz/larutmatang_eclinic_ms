		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<form method="post" action="" name="frmdoct" onSubmit="return validateform()" style="padding: 10px">
					...
					<div class="form-line">
					<input class="form-control" type="text" name="loginid" id="loginid" value=""/>
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="password" name="cnfirmpassword" id="cnfirmpassword" value=""/>
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="number" name="experience" min="1" id="experience" value="" placeholder="Years of Experience" />
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="number" name="consultancy_charge" min="1" step=".01" id="consultancy_charge" value=""/>
				</div>
				</div>
...
if(isset($_POST['submit']))
{
	if(isset($_GET['editid']))
	{
		...
		if($qsql = mysqli_query($con,$sql))
		{
			...
			echo "window.location.href='adminaccount.php';</script>";
		}
		else
		{
	...
	if($qsql = mysqli_query($con,$sql))
	{
		echo "<script>alert('Doctor record inserted successfully');";
		echo "window.location.href='adminaccount.php';</script>";
	}
	else
	{

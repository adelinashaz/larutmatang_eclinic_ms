...
<body class="theme-cyan login-page authentication">
	...
	<div class="card">
		<h1 class="title"><span>Larut Matang E-Clinic Management System</span>Login <span class="msg">Sign in to start your session</span></h1>
		<div class="col-md-12">
...
{	
	...
	$login_id = sanitizeString($_POST['loginid']);
	$password = sanitizeString($_POST['password']);

	$sql = "SELECT * FROM admin WHERE loginid='$login_id' AND password='$password' AND status='Active'";
...
function validateform()
{
	...
	else if(!document.frmadminlogin.password.value.match(alphanumericExp))
	{

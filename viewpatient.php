        ...
        <tbody>
          <?php
            ...
            while($rs = mysqli_fetch_array($qsql))
            {
              ...
              {
                echo "<a href='admineditpatient.php?editid=$rs[patientid]' class='btn btn-sm btn-raised bg-green'>Edit</a><a href='viewpatient.php?delid=$rs[patientid]' class='btn btn-sm btn-raised bg-blush'>Delete</a> <hr>

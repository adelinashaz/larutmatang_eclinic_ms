	...
	if(isset($_POST['submit']))
	{
		if(isset($_GET['editid']))
		{
			...
			if($qsql = mysqli_query($con,$sql))
			{
				...
				echo "<script>window.location='viewappointmentapproved.php?patientid=$_GET[patientid]&appointmentid=$_GET[editid]';</script>";
			}
			else
			{
		...
		else
		{
			...
			$sql ="INSERT INTO appointment(patientid,roomid,departmentid,appointmentdate,appointmenttime,doctorid,status) values('$_POST[select2]','$_POST[select4]','$_POST[select3]','$_POST[select5]','$_POST[appointmentdate]','$_POST[time]','$_POST[select6]','$_POST[select]')";
			if($qsql = mysqli_query($con,$sql))
			{

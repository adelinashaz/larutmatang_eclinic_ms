...
<meta name="author" content="adelinashaz" />
<!-- Document Title -->
<title>Larut Matang E-Clinic Management System</title>
...
<div id="loader">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.html"><img src="images/cliniclogo.png" alt="" style="height: 80px;"></a> </div>
      <div class="head-info">
        <ul>
          ...
          <li> <i class="fa fa-envelope-o"></i>
            <p>lmecms@gmail.com<br>
              info@lmecms.com</p>
          </li>
          <li> <i class="fa fa-map-marker"></i>
            <p>22, Jalan Taming Sari<br>
             Taiping, Perak</p>
          </li>
        </ul>
      </div>

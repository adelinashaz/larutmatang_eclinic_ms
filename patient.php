    ...
    <div class="card">
        <form method="post" action="" name="frmpatient" onSubmit="return validateform()" style="padding: 10px">
            ...
            <div class="form-group"><label>Admission Date</label>
                <div class="form-line">
                    <input class="form-control" type="date" name="admissiondate" id="admissiondate"
                        placeholder="Insert patient's name" readonly />
                </div>
            </div>
            ...
            <div class="form-group">
                <label>Address</label>
                <div class="form-line">
                    <input class="form-control " name="address" id="tinymce" placeholder="Insert patient's address">
                </div>
            </div>
            ...
            <div class="form-group"><label>Mobile Number</label>
                <div class="form-line">
                    <input class="form-control" type="text" name="mobilenumber" id="mobilenumber"
                        placeholder="Insert patient's mobile no." />
                </div>
            </div>
            ...
            <div class="form-group"><label>City</label>
                <div class="form-line">
                    <input class="form-control" type="text" name="city" id="city"
                        placeholder="Insert patient's city" />
                </div>
            </div>
            ...
            <div class="form-group"><label>Postcode</label>
                <div class="form-line">
                    <input class="form-control" type="text" name="pincode" id="pincode"
                        placeholder="Insert patient's postcode" />
                </div>
            </div>
            ...
            <div class="form-group"><label>Login ID</label>
                <div class="form-line">
                    <input class="form-control" type="text" name="loginid" id="loginid"
                        placeholder="Insert patient's loginid" />
                </div>
            </div>
            ...
            <div class="form-group"><label>Password</label>
                <div class="form-line">
                    <input class="form-control" type="password" name="password" id="password"
                        placeholder="Insert patient's password" />
                </div>
            </div>
            ...
            <div class="form-group"><label>Confirm Password</label>
                <div class="form-line">
                    <input class="form-control" type="password" name="confirmpassword" id="confirmpassword"
                        placeholder="Confirm patient's password" />
                </div>
            </div>
...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        if($qsql = mysqli_query($con,$sql))
        {
            ...
            {
                echo "<script>window.location='viewpatient.php?patid=$insid';</script>";    
            }
            else
            {

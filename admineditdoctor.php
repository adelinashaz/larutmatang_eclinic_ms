                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input class="form-control" type="text" name="mobileno" id="mobileno" value="<?php echo $rsedit['mobileno']; ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <select  name="select1" id="select1" class="form-control show-tick">
                                            <option value="">Select</option>
                                            <?php
                                                $sqldepartment= $con->query("SELECT * FROM department WHERE status='Active'");
                                                // $qsqldepartment = mysqli_query($con,$sqldepartment);
                                                while($rsdepartment=mysqli_fetch_array($sqldepartment,MYSQLI_ASSOC))
                                                {
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="">Consultancy Charge</label>
                                        <div class="form-line">
                                            <input class="form-control" type="number" name="consultancy_charge" min="1" step=".01" id="consultancy_charge" value="<?php echo $rsedit['consultancy_charge']; ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>           
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <div class="form-line">
                                            <input class="form-control" type="number" name="experience" min="1" step=".01" id="experience" value="<?php echo $rsedit['experience']; ?>" />
                                       </div>
                                    </div>
                                </div>
                            </div>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        if(isset($_GET['editid']))
        {
            $sql ="UPDATE doctor SET doctorname='$_POST[doctorname]',mobileno='$_POST[mobileno]',departmentid='$_POST[select1]',loginid='$_POST[loginid]',status='$_POST[select2]',education='$_POST[education]',experience='$_POST[experience]',consultancy_charge='$_POST[consultancy_charge]' WHERE doctorid='$_GET[editid]'";
            if($qsql = mysqli_query($con,$sql))
            {
                echo "<script>alert('Doctor record updated successfully');";
                echo "window.location.href='viewdoctor.php';</script>";
            }
            else
            {
...
function validateform()
{
    ...
    else if(document.frmdoct.mobileno.value == "")
    {
        alert("Mobile number should not be empty..");
        document.frmdoct.mobileno.focus();
        return false;
    }
    else if(!document.frmdoct.mobileno.value.match(numericExpression))
    {
